            ...
            <div class="modal-body">
                <ul class="row mb-0 ml-5 mr-5 pt-4 pb-4 pl-0 pr-0">
                  ...
                  <li class="col-xl-12 p-2 g-2 d-flex justify-content-end">
                    <button type="button" id="faqCreateBtn" class="btn btn-success p-2"> <div class="text-1"> Submit </div></button>
                  </li>
                </ul>
            </div>
          </div>
            ...
            <div class="modal-body">
              <form action="" enctype="multipart/form-data">
                <ul class="row mb-0 ml-5 mr-5 pt-4 pb-4 pl-0 pr-0">
                  ...
                  <li class="col-xl-12 p-2 g-2 d-flex justify-content-end">
                    <button type="reset" class="btn btn-secondary p-2"> <div class="text-1"> Reset </div></button>
                    <button type="button" id="faqDeleteBtn" class="btn btn-danger p-2"> <div class="text-1"> Delete </div></button>
                  </li>
                </ul>
              </form>
            </div>

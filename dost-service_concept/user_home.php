        ...
        <div class="right-menu" >
          ...
          <div class="dropdown" data-dropdown-menu>
            ...
            <div class="dropdown-menu" >
              <a class="link"> <img class="link-icon" src="icons/png-files/cogs.png" alt="Settings.png"> Settings</a> 
              <a class="link"> <img class="link-icon" src="icons/png-files/exit.png" alt="Logout.png"> Logout</a>
            </div>

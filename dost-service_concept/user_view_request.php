...
<!-- Sidebar bottom menu -->
        ...
        <main class="content">
          <div class="content-menu">
            <div class="row">
              <div>
                <a href="user_request.php"> <label>Add Request</label> </a>
                <button>Generate Report <img src="icons/png-files/printer.png"></button>
              </div>
              <div>
                <label> <input type="dropdown" name=""> </label>
                <label>Search</label> <input type="text" name="">
              </div>
            </div>

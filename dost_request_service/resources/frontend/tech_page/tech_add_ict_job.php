                        ...
                        <div class="main-container">
                            <div class="row justify-content-between pr-2 pl-2">
                                <div class="col-xl-8 col-lg-12 mb-1 p-0"> 
                                    ...
                                    <input class="col-xl-6 col-lg-12" tabindex="-1" type="text" readonly name="datetime_request" id="datetime_request" value=""> 
                                </div>
                                ...
                                <div class="col-xl-6 col-lg-12">
                                    ...
                                    <ul class="p-0 row">
                                        ...
                                        <li class="mt-2 col-xl-12">
                                            ...
                                            <input class="w-100" style="display: none;" type="text" name="other_req_type" id="other_req_type"> <!-- hidden text -->
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-xl-6 pr-4 pl-4 g-3">
                                    <div class="row p-0 m-0">
                                        <div class="col-xl-12 d-flex flex-row g-2 justify-content-end">
                                            ...
                                            <input type="file" hidden id="real-file" name="real-file">
                                                <button class="middle-button d-flex justify-content-center p-1 g-2 my-shadow" type="button" id="custom-button"> 
                                            ...
                                            <input type="file" hidden multiple id="multiple-file-img" name="multiple-file-img">
                                                <button class="middle-button d-flex justify-content-center p-1 g-2 my-shadow" type="button" id="custom-button-2"> 
                            ...
                            <div class="col p-2">
                                <div class="row-xl-12 pr-3 pl-3">
                                    <ul class="d-flex align-items-center flex-wrap p-0 m-0 g-2">
                                        <li>
                                            <input type="checkbox" name="cables" id="cables" value="cables">
                                        ...
                                        <li>
                                            <input type="checkbox" name="cd/dvd_drive" id="cd/dvd_drive" value="cd/dvd_drive">
                                        ...
                                        <li>
                                            <input type="checkbox" name="power_supply" id="power_supply" value="power_supply">
                                            <label for="power_supply"> Power Supply </label>
                                        </li>
                                        <li>
                                            <input type="checkbox" name="hard_drive" id="hard_drive" value="hard_drive">
                                ...
                                <div class="row-xl-12 pr-3 pl-3 mt-2">
                                    <ul class="row align-items-center p-0 m-0">
                                        <li class="col-xl-4 p-0">
                                            ...
                                            <input type="checkbox" name="software_programs" id="software_programs" value="1">
                                            <label for="software_programs_descrpt"> Software Programs (list): </label>
                                            <textarea class="textarea-j" name="software_programs_descrpt" id="software_programs_descrpt" placeholder="Type here..."></textarea>
                                        </li>
                                        <li class="col-xl-4 p-0">
                                            <label for="other_hardware" hidden></label>
                                            <input type="checkbox" name="other_hardware" id="other_hardware" value="1">
                                            <label for="other_hardware_descrpt"> Other Hardware: </label>
                                            <textarea class="textarea-j" name="other_hardware_descrpt" id="other_hardware_descrpt" placeholder="Type here..."></textarea>
                                        </li>
                                        <li class="col-xl-4 p-0">
                                            <label for="usb_device" hidden></label>
                                            <input type="checkbox" name="usb_device" id="usb_device" value="1">
                                            <label for="usb_device_descrpt"> USB Device: </label>
                                            <textarea class="textarea-j" name="usb_device_descrpt" id="usb_device_descrpt" placeholder="Type here..."></textarea>
                                        </li>
                                    </ul>
                                </div>
                            </div>

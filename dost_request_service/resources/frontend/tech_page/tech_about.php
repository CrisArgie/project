...
<!-- Sidebar bottom menu -->
        ...
        <main class="content">
          <div class="content-menu flex-column">
            ...
            <div class="main-container">
              <div class="row ">
                <di class="col-xl-12 d-flex justify-content-between">
          ...
          <div class="modal-body">
              ...
              <ul class="row mb-0 ml-5 mr-5 pt-4 pb-4 pl-0 pr-0">
                ...
                <li class="col-xl-12 p-2 g-2 d-flex justify-content-end">
                  <button type="button" onclick="clearBtnCtn()" class="ctn-btn p-2"> <div class="text-1"> Reset </div></button>
                  <button type="button" id="faqCreateBtn" class="ctn-btn p-2"> <div class="text-1"> Submit </div></button>
                </li>
              </ul>
...
<script type="text/javascript" src="../afterscript.js" defer onload="accordionFunc(1, 1)"></script>
<script>
